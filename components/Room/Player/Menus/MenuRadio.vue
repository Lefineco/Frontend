<template>
	...
	>
		<media-icon class="h-4 w-4 text-white group-data-[checked]:hidden" type="radio-button" />
		<media-icon class="text-media-brand hidden h-4 w-4 group-data-[checked]:block" type="radio-button-selected" />
