const toggle = {
  ...
  container: {
    base: "pointer-events-none relative inline-block h-3 w-3 self-center rounded-full bg-white dark:bg-gray-900 shadow transform ring-0 transition ease-in-out duration-200",
    active: "translate-x-4 rtl:-translate-x-4",
    inactive: "translate-x-1 rtl:-translate-x-0",
  },
  icon: {
