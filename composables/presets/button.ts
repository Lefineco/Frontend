const button = {
  ...
  variant: {
    primary: 'shadow-sm text-white dark:text-white bg-{color}-500 hover:bg-{color}-600 disabled:bg-{color}-500 dark:bg-{color}-400 dark:hover:bg-{color}-500 dark:disabled:bg-{color}-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-{color}-500 dark:focus-visible:outline-{color}-400',
    secondary: 'text-white bg-white/20 hover:bg-white/30 disabled:bg-white/5 disabled:text-white/30 focus-visible:ring-2 focus-visible:ring-inset',
